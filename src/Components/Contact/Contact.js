                    ...
                    <div className="contact_icons col">
                        <div className="row">
                            <div className="col-lg-3">
                                <a href="https://github.com/Manivannan1792" target="_blank" rel="noreferrer noopener"><i class="fab fa-github"></i></a>
                            </div>
                            <div className="col col-lg-3">
                                <a href="https://www.linkedin.com/in/manivannan-ramamoorthy-159655132/" target="_blank" rel="noreferrer noopener"><i class="fab fa-linkedin"></i></a>
                            </div>
                            <div className="col col-lg-3">
                                <a href="mailto:manimba701@gmail.com?subject=subject text" target="_blank" rel="noreferrer noopener"><i class="fas fa-envelope-open-text"></i></a>
                            </div>
                            <div className="col-lg-3">
