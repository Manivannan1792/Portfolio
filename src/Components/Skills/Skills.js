    ...
    const tech_skills = [
        {
            ...
            "skill": "My SQL", "percent": "80"
        },{
            "skill": "Express", "percent": "75"
        },{
            "skill": "AWS", "percent": "75"
        }]

    const add_skill = [
        {
            "skill": "Quick and smart learner."
        }, {
            "skill": "Easily adaptable with team members and open to learn new things."
        }, {
            "skill": "Good at Communication."
        },{
            "skill": "Flexible and motivated person."
        }]
            ...
            <div className="row">
                ...
                <div className="col-lg-5">
                    <div className="additional_skill mt-3">
                        <h4 data-aos="zoom-in">Soft Skills:</h4>
                        ...
                        <div className="apps_skill text-center mt-4">
                            <h4 data-aos="zoom-in">Knowledge in:</h4>
